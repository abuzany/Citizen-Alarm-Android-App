...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void userSignIn(String email, String password){
        try {
            ...
            Call<UserResponse> postUserSignInCall = ObeliskService.getInstance().getService().postUserSignIn(userLogin);
            postUserSignInCall.enqueue(new Callback<UserResponse>() {
                @Override
                ...
                public void onFailure(Call<UserResponse> call, Throwable t) {
                    Log.e(TAG, "postUserSignInCall->onFailure: " + t.getMessage());
                }
            });
        }
        catch (Exception e){
            Log.e(TAG, "userSignIn->"+e.getMessage());
        }
    }
